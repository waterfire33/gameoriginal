{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/ali/workspace/mmknisali/gameoriginal";
  project_input_ref = "path:/home/ali/workspace/mmknisali/gameoriginal";
  devenv_dotfile = "/home/ali/workspace/mmknisali/gameoriginal/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-e43ac20";
  ...
  hostname = "Clara";
  username = "ali";
  git_root = "/home/ali/workspace/mmknisali/gameoriginal";
  secretspec = null;
};
    in
    {
